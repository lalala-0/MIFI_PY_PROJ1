...
ROOMS = {
    ...
    'hall': {
        ...
        'items': [],
        'puzzle': {'На пьедестале надпись: "Назовите число, которое идет после девяти". Введите ответ цифрой или словом.',
            '10'
        }
    },
    'trap_room': {
    ...
    'library': {
        ...
        'items': ['ancient_book'],
        'puzzle': {'В одном свитке загадка: "Что растет, когда его съедают?" (ответ одно слово)',
            'резонанс'
        }
    },
    'armory': {
    ...
    'hidden_passage': {
        ...
        'items': [],
        'puzzle': {'На стене надпись: "Что открывает путь, когда вокруг тьма?"',
            'свет'
        }
    },
    'secret_chamber': {
