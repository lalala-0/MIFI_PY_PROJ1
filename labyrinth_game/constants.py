...
ROOMS = {
    ...
    'hall': {
        ...
        'items': [],
        'puzzle': {
            'question': 'На пьедестале надпись: '
    ...
    'trap_room': {
        ...
        'items': ['rusty_key'],
        'puzzle': {
            'question': 'Система плит активна. Чтобы пройти, '
    ...
    'library': {
        ...
        'items': ['ancient_book'],
        'puzzle': {
            'question': 'В одном свитке загадка: '
    ...
    'treasure_room': {
        ...
        'puzzle': {
            'question': 'Дверь защищена кодом. Введите код '
    ...
    'hidden_passage': {
        'description': 'Узкий скрытый проход. '
                        'Каменные стены покрыты древними символами. '
                        'На севере видна дверь с таинственным механизмом.',
    ...
    'secret_chamber': {
        'description': 'Тайная комната. В центре лежит небольшой сундук. '
                        'Внутри поблескивает золотой ключ.',
...
TRAP_SURVIVAL_THRESHOLD = 3  # Порог выживания при ловушке
